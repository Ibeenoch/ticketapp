        ...
        children: [
          ...
          Padding(
            padding: EdgeInsets.only(
                left: 15.w, right: 15.w, top: 15.h, bottom: 20.h),
            child: Container(
              decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(8.r),
                  color: AppStyles.backgroundColorlightBlue),
              child: Column(
                ...
                children: [
                  ...
                  inputText(context, password, password_f,
      ...
      children: [
        Container(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(8.r),
                  color: AppStyles.backgroundColorBlue),
              child: TextField(
